...
// GAP GATT Attributes
static uint8 attDeviceName[] = DEIVCE_NAME;
...
#if ((IRTEMP_SENSOR == ENABLE) || (ACCEL_SENSOR  == ENABLE) || (HUMIDITY_SENSOR == ENABLE) ||  (MAG_SENSOR == ENABLE) || (BARO_SENSOR == ENABLE) || (GYRO_SENSOR == ENABLE))
  switch(servUuid)
  {
#if (IRTEMP_SENSOR == ENABLE)
